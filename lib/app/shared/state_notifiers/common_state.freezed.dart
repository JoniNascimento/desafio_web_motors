  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty(
          'type', 'CommonState<$Failed, $Success>.initial'));
  }
...
class _$CommonStateLoading<Failed, Success>
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty(
          'type', 'CommonState<$Failed, $Success>.loading'));
  }
...
class _$CommonStateFailed<Failed, Success>
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(
          DiagnosticsProperty('type', 'CommonState<$Failed, $Success>.failed'))
...
class _$CommonStateSuccessful<Failed, Success>
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty(
          'type', 'CommonState<$Failed, $Success>.successful'))
      ..add(DiagnosticsProperty('success', success))
      ..add(DiagnosticsProperty('booleanOption', booleanOption));
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return successful?.call(success, booleanOption);
  }
